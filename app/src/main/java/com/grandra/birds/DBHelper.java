...
public class DBHelper extends SQLiteOpenHelper {
    static final String DATABASE_NAME = "bird.db";
    ArrayList<Favroite_bird> favroitebirds = new ArrayList<>();
    // DBHelper 생성자
    ...
    // Person Table 데이터 입력
    public void insert(String name, String bird_num, String imageUrl) {
        SQLiteDatabase db = getWritableDatabase();
        db.execSQL("INSERT INTO Person VALUES('" + name + "', '" + bird_num + "', '" + imageUrl + "')");
        db.close();
    }
    ...
    public String getResult() {
        ...
        while (cursor.moveToNext()) {
            ...
            favroitebirds.add(new Favroite_bird(cursor.getString(0),cursor.getString(1),cursor.getString(2)));
            for (Favroite_bird birds : favroitebirds) {
    ...
    public ArrayList<Favroite_bird> getFavroiteplantsss(){
        return favroitebirds;
    }
