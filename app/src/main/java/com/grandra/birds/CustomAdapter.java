...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder>{
    ...
    private ArrayList<String> birdNum;
    private Context context; // Context 변수 추가

    public CustomAdapter(Context context, ArrayList<String> imageUrl, ArrayList<String> birdName, ArrayList<String> birdNum) {
            ...
            public void onClick(View v) {
                if (itemClickListener != null) {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        String data = birdNum.get(position);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String name = birdName.get(position);
        ...
        String Title = birdName.get(position);
        ...
        holder.getCheckBox().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isChecked) {
                    ...
                    dbHelper.insert(title, birdNum.get(position), imageUrl.get(position));
                } else {
